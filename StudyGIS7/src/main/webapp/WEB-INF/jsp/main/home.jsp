...
<body>
	<header
		...
		<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="/StudyGIS7/main.do">Home</a>
		...
		<div class="row">
			<nav id="sidebarMenu"
				...
				<div class="position-sticky pt-3">
					...
					<div class="alert alert-success" role="alert">가산 맛집</div>
					...
					<div class="alert alert-info" role="alert">기본 레이어(Tile)</div>
					...
					<div class="alert alert-warning" role="alert">지도서비스기능(Vector)</div>
					<div class="form-check">
					...
					<div class="alert alert-danger" role="alert">여행</div>
						<button id="food_tour" type="button" class="btn btn-secondary" style="margin-Top:10px">수도권주변</button>
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
					<h1 class="h2">맛집서비스</h1>
					<div class="btn-toolbar mb-2 mb-md-0">
						<div class="btn-group me-2">
							<button id="rotate-left" type="button" class="btn btn-secondary" style="margin:10px">↻</button>
							<button id="rotate-right" type="button" class="btn btn-secondary" style="margin:10px">↺</button>
							<button id="elastic-to-goyang" type="button" class="btn btn-secondary" style="margin:10px">고양(탄성)</button>
							<button id="bounce-to-gwangmyeong" type="button" class="btn btn-secondary" style="margin:10px">광명(바운스)</button>
							<button id="spin-to-anyang" type="button" class="btn btn-secondary" style="margin:10px">안양(회전)</button>
							<button id="fly-to-hanam" type="button" class="btn btn-secondary" style="margin:10px">하남(비행)</button>
							<button id="rotate-around-seoul" type="button" class="btn btn-secondary" style="margin:10px">서울(기준회전)</button>
						</div>
					</div>
				</div>
