...
<head>
    ...
    <c:set var="registerFlag" value="${empty sampleVO.no ? 'create' : 'modify'}"/>
    ...
    <div id="content_pop">
    	...
    	<table width="100%" border="1" cellpadding="0" cellspacing="0" style="bordercolor:#D3E2EC; bordercolordark:#FFFFFF; BORDER-TOP:#C2D0DB 2px solid; BORDER-LEFT:#ffffff 1px solid; BORDER-RIGHT:#ffffff 1px solid; BORDER-BOTTOM:#C2D0DB 1px solid; border-collapse: collapse;">
    		...
    		<c:if test="${registerFlag == 'modify'}">
        		<tr>
        			<td class="tbtd_caption"><label for="no"><spring:message code="title.sample.no" /></label></td>
        			<td class="tbtd_content">
        				<form:input path="no" cssClass="essentiality" maxlength="10" readonly="true" />
        			</td>
        		</tr>
    		</c:if>
    		<tr>
    		...
    		<tr>
    			<td class="tbtd_caption"><label for="bn"><spring:message code="title.sample.bn" /></label></td>
    			<td class="tbtd_content">
					<form:input path="bn" maxlength="30" cssClass="txt"/>
    				&nbsp;<form:errors path="bn" />
    			</td>
    		</tr>
    		<tr>
    			<td class="tbtd_caption"><label for="detail"><spring:message code="title.sample.detail" /></label></td>
    			<td class="tbtd_content">
    				<form:textarea path="detail" rows="5" cols="58" />&nbsp;<form:errors path="detail" />
                </td>
    		</tr>
    	</table>
      </div>
