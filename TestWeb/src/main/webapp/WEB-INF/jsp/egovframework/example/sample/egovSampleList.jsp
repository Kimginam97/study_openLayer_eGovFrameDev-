        	...
        	<div id="table">
        		<table width="100%" border="0" cellpadding="0" cellspacing="0">
        			...
        			<tr>
        				...
        				<th align="center"><spring:message code="title.sample.no" /></th>
        				<th align="center"><spring:message code="title.sample.name" /></th>
        				<th align="center"><spring:message code="title.sample.bn" /></th>
        				<th align="center"><spring:message code="title.sample.detail" /></th>
        			</tr>
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr>
            				...
            				<td align="center" class="listtd"><c:out value="${result.bn}"/>&nbsp;</td>
            				<td align="center" class="listtd"><c:out value="${result.detail}"/>&nbsp;</td>
            			</tr>
        			</c:forEach>
        		</table>
        	</div>
